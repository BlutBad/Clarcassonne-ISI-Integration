...
Template.hall_torneo.events = {
    ...
    'click .soloMenuTorneo' : function(){
        console.log(this);
        if (Session.equals('soloMenuTorneoActive',this.short)){
            Session.set('soloMenuTorneoActive', null);
        }else{
            Session.set('soloMenuTorneoActive', this.short);
        }
    }
};
...
Template.hall_torneo.showRankingTorneo = function() {
    //console.log(Session.equals('multiMenuTorneoActive', 'ranking'), Session.equals('soloMenuTorneoActive', 'ranking'))
    return Session.equals('multiMenuTorneoActive', 'ranking') ||
            Session.equals('soloMenuTorneoActive', 'ranking');
};
...
// El menu del multiTorneo, ETAPAS | RANKING
Template.hall_torneo.soloMenuTorneo = function() {
  return Menu.find({menuType : "soloTorneo"});
};

Template.hall_torneo.soloMenuTorneoActive = function() {
  return Session.equals('soloMenuTorneoActive', this.short) ? 'active' : '';
};

Template.hall_torneo.showParticipantes = function() {
    return Session.equals('soloMenuTorneoActive', 'participantes');
};
