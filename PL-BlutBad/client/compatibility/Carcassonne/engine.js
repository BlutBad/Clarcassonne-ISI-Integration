...
//   (p.ej. level1 en game.js) y una funci�n a la que llamar si el
...
// que ofrecer cualquier objeto a�adido como tablero a Game.boards.
...
// Level implementa draw() porque al a�adirse como tablero a Game el
// bucle Game.loop() va a llamar a step() y a draw(). Pero no hay nada
// que hacer en draw() para un nivel, ya que los sprites de los
// enemigos los a�ade el nivel al tablero de juegos (GameBoard). 
...
// t�ctil de un m�vil o una tableta
 TouchControls = function() {
    ...
    // los botones en la pantalla tactil.  Ver en game.js c�mo hemos
